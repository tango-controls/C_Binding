...
//-----------------------------------------------------------------------------
Tango::DevULong GroupRepository::group_cnt = 0;
...
// GroupRepository::add
//=============================================================================
Tango::DevULong GroupRepository::add (const std::string& _name, 
...
{ 
  ...
  {
    Tango::Except::throw_exception(_CPTC("out of memory"),
			                             _CPTC("binding error: Tango::Group initialization failed"),
			                             _CPTC("GroupRepository::add"));
  }
  catch (Tango::DevFailed& df)
  {
    Tango::Except::re_throw_exception(df,
                                      _CPTC("software error"),
			                                _CPTC("binding error: Tango::Group initialization failed [Tango exception caught]"),
			                                _CPTC("GroupRepository::add"));
  }
  catch (...)
  {
    Tango::Except::throw_exception(_CPTC("software error"),
			                             _CPTC("binding error: Tango::Group initialization failed [unknown exception caught]"),
			                             _CPTC("GroupRepository::add"));
  }
...
//=============================================================================
void GroupRepository::remove (Tango::DevULong _group_id)
    throw (Tango::DevFailed)
{ 
  //- critical section
  omni_mutex_lock guard(this->lock_);
...
//=============================================================================
void GroupRepository::remove_group_i (Tango::DevULong _group_id)
{
