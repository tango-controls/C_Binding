...
class GroupRepository
{
  ...
  typedef std::map<Tango::DevULong, GroupDescriptor*> GroupMap;
...
public:
  ...
  Tango::DevULong add (const std::string& name, 
...
private:
  ...
  void remove_group_i (Tango::DevULong group_id);
