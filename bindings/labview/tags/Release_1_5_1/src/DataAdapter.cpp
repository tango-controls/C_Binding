    ...
    switch(sizeof(_A))
    {
      ...
      default:
        Tango::Except::throw_exception(_CPTC("unexpected data type"),
                                       _CPTC("no support for > 64-bits data types"),
                                       _CPTC("Encode::cmd_scalar"));
        break;
    }
#endif
...
public:
    ...
    throw (Tango::DevFailed)
  {
    ...
    long dn = dest_num_elements - src_num_elements;
    if (dn > 0)
  ...
  try 
  {
    ...
    switch (argin_type) 
    {
      ...
      case Tango::DEVVAR_LONG64ARRAY: 
        ...
        break;
      //-- DEVVAR_ULONG64ARRAY -------------------------
      case Tango::DEVVAR_ULON64GARRAY: 
        {
    ...
    switch (attr_format) 
    {
      ...
      case Tango::IMAGE: 
      {
        ...
        switch (attr_type) 
        {
          ...
          case Tango::DEV_ULONG64: 
            {
              ENCODE_ATTR_ARRAY(Tango::DevVarULong64Array, Tango::DevLongU64, _avp, value_);
            } 
            break;
#endif
    ...
    throw (Tango::DevFailed)
{
  ...
  try 
  {
    ...
    switch (_ddesc->attr_list()[_attr_id].data_type) 
    {
      ...
      case Tango::DEV_ULONG64: 
        {
          DECODE_ATTR_ARRAY(frmt, is_rw, Tango::DevVarULong64Array, Tango::DevLongU64, _value, value_);
        }
        break;
#endif
          ...
          case Tango::SCALAR:
            {
              ...
              std::string s;
              _value >> s;
              long err = ::NumericArrayResize(uB,  1L, reinterpret_cast<UHandle*>(&value_), s.size());
              if (err != noErr) {
                Tango::Except::throw_exception(_CPTC("out of memory error"),
                                               _CPTC("binding internal error: memory allocation failed"),
                                               _CPTC("DataAdapter::decode_attr"));
