...
function test_tango_read_attrs (dev_name)
	...
	//- <AttributeValue.val_path> are mapty strings, the current datafolder will
	...
	//- to be created into the current datafolder. we also want this global variable 
	...
	//- make it unusable in some contexts. a Igor structure can't "live" outside the context 
...
function tango_test_all (dev_name, n_it)
	...
	String cur_df
	tango_enter_device_df(dev_name,  cur_df)
	tools_df_make(":tmp", 1)
	Variable i
	for (i = 0; i < n_it; i += 1)
