...
//    small here - see [1]) . No need to change the target device name (just leave 
//    it as it is).
//
...
// --------------------------
//	[1] : use small functions "prefix" - Igor doesn't like long function names at all.
...
//==============================================================================
//
// There are some contexts in which this low level approcah is required 
