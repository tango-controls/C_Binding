...
//=============================================================================
// DevDescriptor::update_attr_list (THIS MIGHT CAUSE PBS IN THREADED CONTEXT)
//=============================================================================
void DevDescriptor::update_attr_list () throw (Tango::DevFailed)
{
  try 
  {
    if (this->dev_attr_list_) 
  ...
  catch (Tango::DevFailed& e) 
  {
		Tango::Except::re_throw_exception(e,
                                      ...
                                      "DevDescriptor::update_attr_list");
  }
  catch (...) 
  {
