...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "." /I "$(XOP_INC)" /I "$(OMNIORB_INC)" /I "$(TANGO_INC)" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "HAS_TANGO_5_OR_SUP" /Fr /FD /c
# SUBTRACT CPP /X /YX
...
# ADD LINK32 igor.lib XOPSupport_x86.lib omniORB407_rt.lib omniDynamic407_rt.lib COS407_rt.lib omnithread32_rt.lib tango.lib log4tango.lib kernel32.lib gdi32.lib user32.lib comctl32.lib advapi32.lib ws2_32.lib version.lib /nologo /dll /machine:I386 /out:"tango_binding.xop" /libpath:"$(XOP_LIB)" /libpath:"$(OMNIORB_LIB)" /libpath:"$(TANGO_LIB)/shared"
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "." /I "$(XOP_INC)" /I "$(OMNIORB_INC)" /I "$(TANGO_INC)" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "HAS_TANGO_5_OR_SUP" /Fr /FD /GZ /c
# SUBTRACT CPP /X /YX
...
# ADD LINK32 igor.lib XOPSupport_x86d.lib omniORB407_rtd.lib omniDynamic407_rtd.lib COS407_rtd.lib omnithread32_rtd.lib tangod.lib log4tangod.lib kernel32.lib gdi32.lib comctl32.lib user32.lib advapi32.lib ws2_32.lib version.lib /nologo /dll /debug /machine:I386 /out:"tango_binding.xop" /pdbtype:sept /libpath:"$(XOP_LIB)" /libpath:"$(OMNIORB_LIB)" /libpath:"$(TANGO_LIB)/shared"
# SUBTRACT LINK32 /nodefaultlib
