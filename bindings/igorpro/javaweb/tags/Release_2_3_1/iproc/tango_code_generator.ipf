...
static function tango_gen_dev_int (file, prefix, dev_name, cintf)
	...
	fprintf ref_num, "#pragma rtGlobals = 1\n"
	fprintf ref_num, "#pragma version = 1.0\n"
	fprintf ref_num, "#pragma IgorVersion = 6.0\n"
	fprintf ref_num, "\n"
	fprintf ref_num, "//==============================================================================\n"
	fprintf ref_num, "// THIS FILE HAS BEEN GENERATED BY THE TANGO BINDING FOR IGOR PRO - DO NOT EDIT \n"
	fprintf ref_num, "//==============================================================================\n"
	fprintf ref_num, "//  In case you find a bug in the generated code or want to contribute to the   \n"
	fprintf ref_num, "// improvement of the Tango API code generator for Igor Pro, please contact the \n"
	fprintf ref_num, "//         author: nicolas[DOT]leclercq[AT]synchrotron-soleil[DOT]fr            \n"
	fprintf ref_num, "//------------------------------------------------------------------------------\n"
	...
	if (cintf)
		fprintf ref_num, " [used to gen. this tango class API]\n"
	else
		fprintf ref_num, " [used to gen. this specific device API]\n"
	endif
	fprintf ref_num, "//==============================================================================\n"
	fprintf ref_num, "\n"
	fprintf ref_num, "//==============================================================================\n"
