...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "." /I "..\igorxops" /I "$(OMNIORB_INC)" /I "$(TANGO_INC)" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "HAS_TANGO_5_OR_SUP" /Fr /FD /c
# SUBTRACT CPP /X /YX
...
# ADD LINK32 igor.lib XOPSupport_x86.lib omniORB405_rt.lib omniDynamic405_rt.lib COS405_rt.lib omnithread30_rt.lib tango.lib log4tango.lib comctl32.lib ws2_32.lib version.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /machine:I386 /out:"tango_binding.xop" /libpath:"..\igorxops" /libpath:"." /libpath:"$(OMNIORB_LIB)" /libpath:"$(TANGO_LIB)/mix"
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "." /I "..\igorxops" /I "$(OMNIORB_INC)" /I "$(TANGO_INC)" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "HAS_TANGO_5_OR_SUP" /Fr /FD /GZ /c
# SUBTRACT CPP /X /YX
