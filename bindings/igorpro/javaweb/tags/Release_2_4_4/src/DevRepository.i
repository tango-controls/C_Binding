...
// DevDescriptor::proxy
//=============================================================================
XDK_INLINE yat4tango::ThreadSafeDeviceProxy* DevDescriptor::proxy (void) const
{
...
//=============================================================================
XDK_INLINE const Tango::CommandInfoList& DevDescriptor::cmd_list (void) const
{
...
//=============================================================================
XDK_INLINE const Tango::AttributeInfoList& DevDescriptor::attr_list (void) const
{
