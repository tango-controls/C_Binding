...
static const char * kTimestampObjName = "timestamp";
                             ...
                             Tango::DeviceData& dd_in_)
{
  if (_ddesc == 0) 
  {
    XOP_ERROR(("DataCodec::encode_argin::invalid argument (NULL)"));
  ...
  {
    XOP_ERROR(("DataCodec::encode_argin::get_obj_df failed"));
    XDK_UTILS->set_error("XOP internal error",
    ...
    switch (attr_format) 
    {
      case Tango::SCALAR: 
      {
        switch (attr_type) 
        {
          case Tango::DEV_STRING: 
          {
            if (XDK_UTILS->fetch_wave(&num_wave, dfh, obj_name, TEXT_WAVE_TYPE)) 
            {
              //- does the user provide the actual argin or a string containing argin?
              //- first try to get a global string var named <_argin> in <dfh>
              //- if there is no string var named <_argin> in <dfh> <_argin> is unchanged
            ...
            else
            {
              ...
              dim_indx[0] = 0;
              if (::MDGetTextWavePointValue(num_wave, dim_indx, txt_hndl)) 
              {
          ...
          case Tango::DEV_BOOLEAN: 
          {
            ...
            if (XDK_UTILS->get_df_obj (dfh, obj_name, &d)) 
            {
              if (XDK_UTILS->fetch_wave(&num_wave, dfh, obj_name, NT_I8|NT_UNSIGNED)) 
              {
                std::string d = "wave <" + _argin + ">";
                d += " either does not exists";
                d += " or has incompatible type/dimensions";
              ...
              long offset;
              if (::MDAccessNumericWaveData(num_wave, kMDWaveAccessMode0, &offset))
              {
                XDK_UTILS->set_error("XOP internal error",
              ...
              b = *(reinterpret_cast<unsigned char*>(static_cast<char*>(*num_wave) + offset)) ? true : false;
            }
            else
            {
              b = d ? true : false;
          ...
          case Tango::DEV_UCHAR: 
          {
            ...
            if (XDK_UTILS->get_df_obj (dfh, obj_name, &d)) 
            {
              ...
              us = *(reinterpret_cast<unsigned char*>(static_cast<char*>(*num_wave) + offset));
            }
            else 
            {
         ...
         case Tango::DEV_USHORT: 
          {
            ...
            if (XDK_UTILS->get_df_obj (dfh, obj_name, &d)) 
            {
              if (XDK_UTILS->fetch_wave(&num_wave, dfh, obj_name, NT_I16)) 
              {
                std::string d = "wave <" + _argin + ">";
                d += " either does not exists";
                d += " or has incompatible type/dimensions";
              ...
              us = *(reinterpret_cast<unsigned short*>(static_cast<char*>(*num_wave) + offset));
            } 
            else 
            {
              if (::ConvertData2(&d, &us, 1, NT_FP64, NT_I16|NT_UNSIGNED)) 
          ...
          case Tango::DEV_SHORT: 
          {
            ...
            if (XDK_UTILS->get_df_obj (dfh, obj_name, &d)) 
            {
              ...
              s = *(reinterpret_cast<short*>(static_cast<char*>(*num_wave) + offset));
            }
            else 
            {
              if (::ConvertData2(&d, &s, 1, NT_FP64, NT_I16)) 
          ...
          case Tango::DEV_LONG: 
          {
            ...
            if (XDK_UTILS->get_df_obj (dfh, obj_name, &d)) 
            {
              if (XDK_UTILS->fetch_wave(&num_wave, dfh, obj_name, NT_I32)) 
              {
                std::string d = "wave <" + _argin + ">";
                d += " either does not exists";
                d += " or has incompatible type/dimensions";
              ...
              l = *(reinterpret_cast<long*>(static_cast<char*>(*num_wave) + offset));
            }
            else 
            {
              if (::ConvertData2(&d, &l, 1, NT_FP64, NT_I32)) 
          ...
          case Tango::DEV_FLOAT: 
          {
            ...
            if (XDK_UTILS->get_df_obj (dfh, obj_name, &d)) 
            {
              if (XDK_UTILS->fetch_wave(&num_wave, dfh, obj_name, NT_FP32)) 
              {
                std::string d = "wave <" + _argin + ">";
                d += " either does not exists";
                d += " or has incompatible type/dimensions";
              ...
              f = *(reinterpret_cast<float*>(static_cast<char*>(*num_wave) + offset));
            }
            else 
            {
              if (::ConvertData2(&d, &f, 1, NT_FP64, NT_FP32)) 
          ...
          case Tango::DEV_DOUBLE: 
          {
            ...
            if (XDK_UTILS->get_df_obj (dfh, obj_name, &d)) 
            {
              if (XDK_UTILS->fetch_wave(&num_wave, dfh, obj_name, NT_FP64)) 
              {
                std::string d = "wave <" + _argin + ">";
                d += " either does not exists";
                d += " or has incompatible type/dimensions";
              ...
              d = *(reinterpret_cast<double*>(static_cast<char*>(*num_wave) + offset));
            }
            value_ << d;
            value_.dim_x = 1;
            value_.dim_y = 0;
      ...
      case Tango::IMAGE: 
      {
        ...
        if (XDK_UTILS->fetch_wave(&num_wave, dfh, obj_name, itype, (attr_format == Tango::IMAGE) ? 2 : 1)) 
        {
          std::string d = "wave <" + _argin + ">";
          d += " either does not exists";
          d += " or has incompatible type/dimensions";
        ...
        {
          case Tango::SPECTRUM:
            this->insert(value_, num_wave, w_dims[0]); 
            value_.dim_x = w_dims[0];
            value_.dim_y = 0;
            break;
          case Tango::IMAGE:
            this->insert(value_, num_wave, w_dims[0], w_dims[1]); 
            value_.dim_x = w_dims[0];
  ...
  try 
  {
    ...
    switch (attr_format) 
    {
      case Tango::SCALAR: 
      {
        switch (attr_type) 
        {
          case Tango::DEV_STATE: 
          {
            Tango::DevState s;
            value_ >> s;
            err = XDK_UTILS->create_df_obj(dfh, obj_name, static_cast<double>(s), 0, 1);  
            if (err) 
            {
              std::string d = "failed to set global string <" + _argout + ">";
              d += " (object name conflict)";
            ...
            err = XDK_UTILS->create_df_obj(dfh, kTimestampObjName, tstamp);  
            if (err) 
            {
              std::string d = "failed to set global variable <" + _argout + ">";
              d += " (object name conflict)";
          ...
          case Tango::DEV_BOOLEAN: 
          {
            bool b;
            value_ >> b;
            err = XDK_UTILS->create_df_obj(dfh, obj_name, (b ? 1. : 0.), tstamp, 1);  
            if (err) 
            {
              std::string d = "failed to set global variable <" + _argout + ">";
              d += " (object name conflict)";
          ...
          case Tango::DEV_UCHAR: 
          {
            unsigned char uc;
            value_ >> uc;
            err = XDK_UTILS->create_df_obj(dfh, obj_name, uc, tstamp, 1);  
            if (err) 
            {
              std::string d = "failed to set global variable <" + _argout + ">";
              d += " (object name conflict)";
          ...
          case Tango::DEV_USHORT: 
          {
            unsigned short us;
            value_ >> us;
            err = XDK_UTILS->create_df_obj(dfh, obj_name, us, tstamp, 1);  
            if (err) 
            {
              std::string d = "failed to set global variable <" + _argout + ">";
              d += " (object name conflict)";
          ...
          case Tango::DEV_SHORT: 
          {
            short s;
            value_ >> s;
            err = XDK_UTILS->create_df_obj(dfh, obj_name, s, tstamp, 1);  
            if (err) 
            {
              std::string d = "failed to set global variable <" + _argout + ">";
              d += " (object name conflict)";
          ...
          case Tango::DEV_LONG: 
          {
            long l;
            value_ >> l;
            err = XDK_UTILS->create_df_obj(dfh, obj_name, l, tstamp, 1);  
            if (err) 
            {
              std::string d = "failed to set global variable <" + _argout + ">";
              d += " (object name conflict)";
          ...
          case Tango::DEV_FLOAT: 
          {
            float f;
            value_ >> f;
            err = XDK_UTILS->create_df_obj(dfh, obj_name, f, tstamp, 1); 
            if (err) 
            {
              std::string d = "failed to set global variable <" + _argout + ">";
              d += " (object name conflict)";
          ...
          case Tango::DEV_DOUBLE: 
          {
            double d;
            value_ >> d;
            err = XDK_UTILS->create_df_obj(dfh, obj_name, d, tstamp, 1); 
            if (err) 
            {
              std::string d = "failed to set global variable <" + _argout + ">";
              d += " (object name conflict)";
      ...
      case Tango::IMAGE: 
      {
        ...
        this->extract(value_, num_wave, w_dims[0], w_dims[1]); 
...
public: 
  ...
  static int txt_wave (const A* _seq, waveHndl _wh)
  {
    if (_seq == 0)
      return kError;
    long w_ndims = 0;
...
void DataCodec::extract (const Tango::DeviceAttribute& _const_da, waveHndl _wh, long _dim_x, long _dim_y)
{
  ...
  switch (::WaveType(_wh)) 
  {
    case NT_I8:
    {
      ...
      {
        if (tango_array) delete tango_array;
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
        reason << "XOP internal error" << ends;
