...
# ADD LINK32 igor.lib XOPSupport_x86.lib omniORB405_rt.lib omniDynamic405_rt.lib COS405_rt.lib omnithread30_rt.lib tango.lib log4tango.lib kernel32.lib gdi32.lib user32.lib comctl32.lib advapi32.lib ws2_32.lib version.lib /nologo /dll /machine:I386 /out:"tango_binding.xop" /libpath:"$(XOP_LIB)" /libpath:"$(OMNIORB_LIB)" /libpath:"$(TANGO_LIB)/shared"
